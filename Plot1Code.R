...
hist(f2$Global_active_power, col="red",xlab="Globl Active Power (kilowatts)",ylab="Frequency",xaxt='n', breaks=16, main="Global Active Power",ylim=c(0,1200), xlim=c(0,16))
